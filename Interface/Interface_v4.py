...
class Interface(tk.Tk):
    ...
    def CreerUneMission(self):
        ...
        self.cumission_labelframe1 = LabelFrame(self.cumission_labelframe, width=300, height=600, bg="#a4a1a3", relief=SUNKEN)
        self.cumission_labelframe1.place(relx=0.1, rely=0.08)
        self.cumission_boutton_decollage = Button(self.cumission_labelframe1, text="Décollage", font=("Arial", 12), width=25, height=2)
        self.cumission_boutton_decollage.place(relx=0.1, rely=0.05)
        self.cumission_boutton_balise1 = Button(self.cumission_labelframe1, text="Balise 1", font=("Arial", 12), width=25, height=2)
        self.cumission_boutton_balise1.place(relx=0.1, rely=0.18)
        self.cumission_boutton_atterissage = Button(self.cumission_labelframe1, text="Atterissage", font=("Arial", 12), width=25, height=2)
        ...
        self.cumission_boutton_etape = Button(self.cumission_labelframe, text="+", font=("Arial", 16, "bold"), width=10, bg="#a4a1a3")
        ...
        self.cumission_labelframe2 = LabelFrame(self.cumission_labelframe, width=400, height=600, borderwidth=3)
    ...
    def VisualiserLesMissions(self):
        self.vlm_labelframe_utilisateur = LabelFrame(self, text="", font=("Arial_black", 12), width=1070, height=800, borderwidth=3)
        ...
        self.vlm_frame_listemission = LabelFrame(self.vlm_labelframe_utilisateur, width=300, height=600, bg="#a4a1a3", relief=SUNKEN)
        ...
        self.vlm_boutton_modifmission = Button(self.vlm_labelframe_utilisateur, text="+", font=("Arial", 16, "bold"), width=10, bg="#a4a1a3")
        ...
        self.vlm_boutton_suppmission = Button(self.vlm_labelframe_utilisateur, text="-", font=("Arial", 16, "bold"), width=10, bg="#a4a1a3")
        ...
        self.vlm_labelframe_mission1 = LabelFrame(self.vlm_labelframe_utilisateur, width=400, height=330, borderwidth=3)
        ...
        self.vlm_boutton_lancermission = Button(self.vlm_labelframe_mission1, text="Lancer la mission", font=("Arial", 12), bg="#a4a1a3", width=30, height=1)
        self.vlm_boutton_lancermission.place(relx=0.18, rely=0.85)
        self.vlm_labelframe_mission2 = LabelFrame(self.vlm_labelframe_utilisateur, width=400, height=330, borderwidth=3)
